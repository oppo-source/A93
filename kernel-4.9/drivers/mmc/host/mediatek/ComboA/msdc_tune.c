...
#ifdef VENDOR_EDIT
/*tianwen@PSW.BSP.Storage, 2020-06-4, add for control T card POWER_CYCLE_FAIL_CONTINUOUS */
extern unsigned int sysctl_tflash_power_fail_cnt;
#endif /*VENDOR_EDIT*/
...
/*tianwen@PSW.BSP.Storage, 2020-06-4, add for control T card POWER_CYCLE_FAIL_CONTINUOUS */
	...
	if ((ret && (host->power_cycle_cnt > MSDC_MAX_POWER_CYCLE_FAIL_CONTINUOUS)) || (host->power_cycle_cnt > sysctl_tflash_power_fail_cnt)) {
