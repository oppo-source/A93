...
static int mt_set_anim_boost(int boost)
{
	set_anim_boost(boost);
	return 0;
}

static int mt_set_upgrade_flag(int upgrade_flag)
{
	set_upgrade_flag(upgrade_flag);
	pr_err("qiziyu mtk_op :%d\n",upgrade_flag);
	return 0;
}
...
static struct hypnus_chipset_operations mediatek_op = {
	...
	.set_anim_boost = mt_set_anim_boost,
	.set_upgrade_flag = mt_set_upgrade_flag,
};
