...
#ifdef VENDOR_EDIT
/* LiYue@BSP.CHG.Basic, 2020/07/01, add for charger type detect*/
	bool attach;
#endif
...
/*lizhijie@BSP.CHG.Basic. 2020/04/17 lzj add for support hvdcp*/
	...
	if (!attach) {
#ifdef VENDOR_EDIT
/*lizhijie@BSP.CHG.Basic 2020/03/26 lzj add for hvdcp*/
		if (mpci->support_hvdcp == true) {
...
#ifdef VENDOR_EDIT
/*lizhijie@BSP.CHG.Basic 2020/04/23 lzj add for charger*/
...
bool oppo_check_hvdcp_support(void)
{
	if (oppompci)
		return oppompci->support_hvdcp;
	else
		return false;
}
#endif
