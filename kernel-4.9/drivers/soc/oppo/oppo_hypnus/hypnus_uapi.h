...
#define IOCTL_HYPNUS_SET_ANIM_BOOST \
	_IOW(HYPNUS_IOC_MAGIC, 0x27, struct hypnus_anim_boost_prop)
#define IOCTL_HYPNUS_SET_UPGRADE_FLAG \
		_IOW(HYPNUS_IOC_MAGIC, 0x28, struct hypnus_upgrade_prop)
...
struct hypnus_anim_boost_prop {
    int anim_boost;
};

struct hypnus_upgrade_prop {
    int upgrade_flag;
};
