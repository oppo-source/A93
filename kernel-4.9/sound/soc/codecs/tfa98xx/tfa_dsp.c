...
int tfa98xx_dsp_system_stable(struct tfa_device *tfa, int *ready)
{
 ...
 */
int tfa98xx_get_mtp(struct tfa_device *tfa, uint16_t *value)
{
	int status;
	int result;
...
int tfa98xx_set_mtp(struct tfa_device *tfa, uint16_t value, uint16_t mask)
{
