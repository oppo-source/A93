...
#ifdef VENDOR_EDIT
// ziyu.qi@cpu_cooling, 2020/07/24, add for ux boost
extern void set_anim_boost(int boost);
extern int oppo_OTA_upgrade;
extern void set_upgrade_flag(int upgrade_flag);
