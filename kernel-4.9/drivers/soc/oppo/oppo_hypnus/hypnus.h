...
long hypnus_ioctl_set_anim_boost(struct hypnus_data *pdata, unsigned int cmd, void *data);
long hypnus_ioctl_set_upgrade_flag(struct hypnus_data *pdata,unsigned int cmd, void *data);
#endif
