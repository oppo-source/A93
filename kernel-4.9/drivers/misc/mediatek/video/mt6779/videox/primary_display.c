...
#ifdef VENDOR_EDIT
/* Hao.Lin@PSW.MM.Display.LCD.Stability, 2020/06/19, add for lcm change */
static int read_lcm_change = 0;
extern int lcm_first_get_serial(void);
#endif /*VENDOR_EDIT*/
 ...
 * command to the panel */
	if (oppo_display_fppress_support && primary_display_get_power_mode_nolock() == FB_RESUME && (ds_rec_fpd || doze_rec_fpd)) {
