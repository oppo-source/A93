...
static const int mt6360_current_19541[MT6360_LEVEL_NUM] = {
...
static int mt6360_ioctl(unsigned int cmd, unsigned long arg)
{
	...
	case FLASH_IOC_GET_DUTY_CURRENT:
		...
		} else if(is_project(OPPO_19541)){
			fl_arg->arg = mt6360_current_19541[fl_arg->arg];
			pr_debug("19541 flashligth");
		} else
		#endif
		{
