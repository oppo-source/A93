...
ifneq ($(filter oppo6779_19551 oppo6779_19537 oppo6779_18593 oppo6779_19301, $(OPPO_TARGET_DEVICE)),)
...
#ifdef VENDOR_EDIT
#Tanbowen@camera,driver, 2020/4/24, add for 19537 camera config
ifneq ($(filter oppo6779_19537, $(OPPO_EUCLID_TARGET_DEVICE)),)
$(shell sed -i 's/CONFIG_CUSTOM_KERNEL_IMGSENSOR=*.*/CONFIG_CUSTOM_KERNEL_IMGSENSOR=\"gm1st_mipi_raw ov32a_mipi_raw imx471_mipi_raw hi846_mipi_raw gc02m0b_mipi_mono0 gc02m1b_mipi_mono0 gc02m0b_mipi_mono1 gc02m1b_mipi_mono1 gc02m0b_mipi_mono2 gc02m1b_mipi_mono2 ov02b1b_mipi_mono\"/g' $(KERNEL_CONFIG_FILE))
endif
#endif
