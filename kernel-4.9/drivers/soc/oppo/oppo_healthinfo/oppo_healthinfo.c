...
#define OHM_CTRL_VMA_ALLOC_ERR        BIT(OHM_MEM_VMA_ALLOC_ERR)
...
EXPORT_SYMBOL(cpu_oom_event_enable);
...
/************** vm_search_two_way:START  ****************/
int vm_search_two_way = 3;
static ssize_t vm_search_two_way_op_read(struct file *filp, char __user *buff, size_t count, loff_t *off)
{
        char page[256] = {0};
        int len = 0;
