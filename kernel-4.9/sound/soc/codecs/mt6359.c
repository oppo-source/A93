...
static const struct snd_kcontrol_new mt6359_snd_controls[] = {
	...
	/* Jun.Liang@PSW.MM.AudioDriver.Codec, 2020/05/20,
	 * add for setting different registers in voice */
	SOC_ENUM_EXT("EXT_AMP_VOICE_SETTING", dl_pga_enum[5], ext_amp_voice_get, ext_amp_voice_set),
	/* Jun.Liang@PSW.MM.AudioDriver.Codec, 2020/05/28,
	* add for reduce aw87339 output voltage */
	SOC_ENUM_EXT("Ext_AMP_LOW_VOLTAGE", dl_pga_enum[6], ext_amp_low_voltage_get, ext_amp_low_voltage_set),
	#endif
};
