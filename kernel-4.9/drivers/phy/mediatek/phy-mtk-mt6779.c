...
#ifdef VENDOR_EDIT
/*lizhijie@BSP.CHG.Basic. 2020/05/13 lzj add for otg*/
...
#ifdef VENDOR_EDIT
/*lizhijie@BSP.CHG.Basic. 2020/05/13 lzj add for otg*/
			instance->phy_tuning.host_u2_vrt_ref = instance->phy_tuning.u2_vrt_ref;
			instance->phy_tuning.host_u2_term_ref = instance->phy_tuning.u2_term_ref;
			instance->phy_tuning.host_u2_enhance = instance->phy_tuning.u2_enhance;
			/* value won't be updated if property not being found */
...
#ifdef VENDOR_EDIT
/*lizhijie@BSP.CHG.Basic. 2020/05/13 lzj add for otg*/
	printk(KERN_ERR "usb_mode:%d [%d %d %d %d %d %d]\n", usb_mode,
				 instance->phy_tuning.host_u2_vrt_ref, instance->phy_tuning.host_u2_term_ref,  instance->phy_tuning.host_u2_enhance,
				 instance->phy_tuning.u2_vrt_ref, instance->phy_tuning.u2_term_ref, instance->phy_tuning.u2_enhance);
#endif
#ifdef VENDOR_EDIT
/*lizhijie@BSP.CHG.Basic. 2020/05/13 lzj add for otg*/
	if (usb_mode == 0) {  //host
...
static int phy_ioread(struct mtk_phy_instance  *instance, u32 reg)
{
	if (reg < instance->port_rgsz)
		//#ifndef VENDOR_EDIT
		/*lizhijie@BSP.CHG.Basic. 2020/05/08 lzj add for otg*/
