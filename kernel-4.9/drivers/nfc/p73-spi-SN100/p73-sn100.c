...
#include "p73-sn100.h"
#include "../pn553-i2c-SN100/pn553-sn100.h"
...
extern long  pn544_dev_ioctl_sn100(struct file *filp, unsigned int cmd,
        unsigned long arg);
...
#define P61_DBG_MSG(msg...)  \
        ...
        break;                 \
        case P61_FULL_DEBUG:     \
        printk(KERN_INFO "[NXP-P73] :  " msg); \
        break; \
        default:                 \
        printk(KERN_ERR "[NXP-P73] :  Wrong debug level %d", debug_level); \
        break; \
        } \

#define P61_ERR_MSG(msg...) printk(KERN_ERR "[NFC-P73] : " msg );
        ...
        unsigned long arg)
{
    ...
    P61_DBG_MSG(KERN_ALERT "p61_dev_ioctl-Enter %u arg = %lu\n", cmd, arg);
    ...
    case P61_GET_ESE_ACCESS:
        ...
        ret = pn544_dev_ioctl_sn100(filp, P544_GET_ESE_ACCESS, arg);
    ...
    case P61_SET_POWER_SCHEME:
        ...
        ret = pn544_dev_ioctl_sn100(filp, P544_SET_POWER_SCHEME, arg);
    ...
    case P61_INHIBIT_PWR_CNTRL:
        ...
        ret = pn544_dev_ioctl_sn100(filp, P544_SECURE_TIMER_SESSION, arg);
        ...
        loff_t *offset)
{
    ...
    P61_DBG_MSG(KERN_ALERT "p61_dev_write -Enter count %lu\n", count);
        ...
        loff_t *offset)
{
    ...
    if (p61_dev->enable_poll_mode)
    {
        ...
        P61_DBG_MSG(KERN_INFO"SPI_READ returned %lu", count);
        //#ifndef VENDOR_EDIT
        //Weiwei.Deng@CN.NFC.Basic.Hardware,1779213, 2019/01/08,
        //Mod for buf for transceive SPI data
    ...
    P61_DBG_MSG(KERN_INFO"total_count = %lu", count);
...
static int p61_probe(struct spi_device *spi)
{
    ...
    P61_ERR_MSG("%s:%d start sN100T,project: %d\n", __func__, __LINE__, get_project());

    if(get_project() == 19539){
        P61_ERR_MSG("%s:%d project use SN100T!\n", __func__, __LINE__);
    } else {
        P61_ERR_MSG("%s:%d Do not support eSE return(sn100)\n", __func__, __LINE__);
        return -ENODEV;
    }
